...
<div class="container content">
	...
	<h2>Our Team</h2>
	<p>We are a dedicated team of professionals with diverse backgrounds in technology, law enforcement, and community services. Our combined expertise allows us to tackle the complex challenges of finding missing persons and providing support to affected families. We are passionate about our mission and committed to making a difference.</p>
</div>
...
<div class="container team-section">
	...
	<div class="row">
		<div class="col-md-4 team-member">
			<img src="<?php $control->path('images/kelvin.jfif'); ?>" alt="Team Member">
			<h4>Kelvin Anwenede</h4>
			<p>Co - Founder</p>
		</div>
		<div class="col-md-4 team-member">
			<img src="<?php $control->path('images/gift.jfif'); ?>" alt="Team Member">
			<h4>Gift Aghaulor</h4>
			<p>Co - Founder</p>
		</div>
		<div class="col-md-4 team-member">
			<img src="<?php $control->path('images/abraham.jfif'); ?>" alt="Team Member">
			<h4>Abraham Livinus</h4>
			<p>Co - Founder</p>
		</div>
	</div>
</div>