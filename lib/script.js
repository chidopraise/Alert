...
///////////////////Here I Wrote The Code That Handles All Asyncronous / background Code Execution///////
...
////////////////Load for Asynchronous Ends Here//////////////////////////////////////

//////////// this controls the div #loading ////////////////
...
document.getElementById('search-form').addEventListener('submit', function(e) {
	...
	// Check if input is an IP address or latitude/longitude coordinates
	if (validateIpAddress(location)) {
		...
		// If it's a latitude/longitude coordinate, split it and use for map center
...
function getLocationFromIP(ip) {
	// Replace 'API_KEY' with your actual IP geolocation API key or use a free API (ipapi.co)
